...
# 因为数据从encoder生成，到保存，到再读出，都需要是bhwc格式，都需要修改！
from verify13_fastpolicy.generator import DataGenerator
...
from verify13_fastpolicy.sampling import Sampler
    ...
    def consolidate_games(self, name, samples):
        ...
        for file_name in file_names:
            ...
            for feature_file in glob.glob(base):
                ...
                x = x.astype(np.int8)
                y = to_categorical(y.astype(np.int8), 19 * 19)
